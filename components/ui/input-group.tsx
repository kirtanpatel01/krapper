  ...
  return (
    <div
      ...
      className={cn(
        ...
        "data-[invalid=true]:border-destructive data-[invalid=true]:ring-destructive/20 dark:data-[invalid=true]:ring-destructive/40 data-[invalid=true]:has-[[data-slot=input-group-control]:focus-visible]:ring-destructive/20 data-[invalid=true]:bg-destructive/10 data-[invalid=true]:has-[[data-slot=input-group-control]:focus-visible]:border-destructive",
        className
      )}
      {...props}
    />
...
const inputGroupAddonVariants = cva(
  "text-muted-foreground **:data-[slot=kbd]:bg-muted-foreground/10 h-auto gap-2 py-2 text-sm font-medium group-data-[disabled=true]/input-group:opacity-50 **:data-[slot=kbd]:rounded-4xl **:data-[slot=kbd]:px-1.5 [&>svg:not([class*='size-'])]:size-4 flex cursor-text items-center justify-center select-none group-data-[invalid=true]/field:text-destructive group-data-[invalid=true]/field:**:data-[slot=kbd]:bg-destructive/10 group-data-[invalid=true]/field:**:data-[slot=kbd]:text-destructive",
  {
    variants: {
      align: {
...
function InputGroupText({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "text-muted-foreground gap-2 text-sm [&_svg:not([class*='size-'])]:size-4 flex items-center [&_svg]:pointer-events-none group-data-[invalid=true]/field:text-destructive",
        className
      )}
      {...props}
    />
